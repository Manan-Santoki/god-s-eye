...
DISPOSABLE_EMAIL_DOMAINS_SAMPLE = {
    ...
    "tempinbox.com", "10minutemail.com", "getairmail.com",
}

# ── Common subdomain prefixes for brute-force enumeration ──
COMMON_SUBDOMAINS = [
    "www", "mail", "ftp", "smtp", "pop", "pop3", "imap",
    "webmail", "email", "mx", "mx1", "mx2",
    "api", "api2", "rest", "graphql", "grpc",
    "dev", "staging", "stage", "test", "qa", "uat", "demo",
    "sandbox", "beta", "alpha", "preview",
    "admin", "panel", "dashboard", "portal", "cp",
    "app", "apps", "mobile", "m",
    "blog", "shop", "store", "cdn", "static", "assets",
    "help", "support", "docs", "wiki",
    ...
    "news", "events", "forum", "community",
    "secure", "ssl", "https",
    "data", "analytics", "track", "pixel",
]
